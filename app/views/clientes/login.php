  ...
  <div class="row">
    <div class="col-md-6 mx-auto">
      <div class="card card-body bg-light mt-5">
        <h2>Login</h2>
        <form action="<?php echo URLROOT; ?>/clientes/login" id="form" method="post">
          ...
          <div class="row">
            ...
            <div class="col">
              <a href="<?php echo URLROOT; ?>/clientes/registrar" class="btn btn-light btn-block">Não tem conta? Registre-se</a>
            </div>
          </div>
        </form>
      </div>
